...
"""
================================================================================
GRAVITY CLOSURE ENGINE -- Admissibility Physics Engine v3.5
================================================================================
...
Run:  python3 Admissibility_Physics_Gravity_V3_5.py
================================================================================
"""
...
def check_signature():
    ...
    return _result(
        ...
        tier=5,
        # Red-team fix #3: This imports HKM + Malament -- label as C_structural
        epistemic='C_structural',
        summary=(
            'A4 irreversibility => strict partial order (logical implication). '
            'HKM: all hypotheses verified (H2 by chartability bridge). '
        ...
        dependencies=['A4', 'Gamma_continuum'],
        imported_theorems={
            'Hawking-King-McCarthy (1976)': {
                'statement': 'Causal structure -> conformal Lorentzian class',
                'our_use': 'A4 order + chartability -> HKM hypotheses satisfied.',
            },
            'Malament (1977)': {
                'statement': 'Causal structure determines conformal geometry',
